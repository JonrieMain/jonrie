  ...
  return (
    ...
    {/* for 1st batch */}
                    ...
                    <div className="date">5/24/2022</div>
                        ...
                        <h3>Steve Francis Samaco <small>(ICT Student)</small></h3>
                    ...
                    <div className="date">5/28/2022</div>
                        ...
                        <h3>Rainier Barredo <small>(ICT Student)</small></h3>
                    ...
                    <div className="date">6/1/2022</div>
                        ...
                        <h3>Lheymar Catapang <small>(ICT Student)</small></h3>
                    ...
                    <div className="date">12/13/2022</div>
                        ...
                        <h3>Charles Francis <br /><small>(BSIT Student)</small></h3>
                        <a target='_blank' href="#">View</a>
                    ...
                    <div className="date">1/11/2023</div>
                        ...
                        <h3>Jerome Bulosan <br /><small>(BSIT Student)</small></h3>
                        <a target='_blank' href="#">View</a>
                    ...
                    <div className="date">4/9/2023</div>
                        ...
                        <h3>Melissa Ayala <br /> <small>(BSIT Student)</small></h3>
                        <a target='_blank' href="#">View</a>
                    ...
                    <div className="date">5/25/2023</div>
                        ...
                        <h3>Kristine Ocan Dingle <br /><small>(BSIT Student)</small></h3>
                        <a target='_blank' href="#">View</a>
                    ...
                    <div className="date">9/1/2023</div>
                        ...
                        <h3>Nathaniel Bianito <br /> <small>(BSIT Student)</small></h3>
                        <a target='_blank' href="#">View</a>
                    ...
                    <div className="date">9/14/2023</div>
                        ...
                        <h3>Scarlett Soledad <br /> <small>(BSIT Student)</small></h3>
                        <a target='_blank' href="#">View</a>
                    ...
                    <div className="date">9/24/2023</div>
                        ...
                        <h3>Jolina Agojo <br /><small>(BSCS Student)</small></h3>
                        <a target='_blank' href="#">View</a>
                    ...
                    <div>
                        ...
                        <h3>Hannah Isabel Dimayuga <br /> <small>(BSCS Student)</small></h3>
                    ...
                    <div>
                        ...
                        <h3>Shiela Mae Saavedra <br /> <small>(BSIT Student)</small></h3>
                        <a target='_blank' href="#">View</a>
                    ...
                    <div>
                        ...
                        <h3>Mariel F. Catubay <br /> <small>(BSIT Student)</small></h3>
                        <a target='_blank' href="#">View</a>
