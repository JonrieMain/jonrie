             ...
             <div className="saysAboutMe">
                ...
                <div id="scroll">
                    ...
                    <div data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <h3><a target="_blank" href="https://web.facebook.com/stevefrancis.galo.1"><i className="fa-brands fa-facebook"></i></a> Steve Francis Samaco <small>(Student)</small></h3>
                    ...
                    <div data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <h3><a target="_blank" href="https://web.facebook.com/rainier.barredo24"><i className="fa-brands fa-facebook"></i></a> Rainier Barredo <small>(Student)</small></h3>
                    ...
                    <div data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <h3><a target="_blank" href="https://web.facebook.com/profile.php?id=100078333846946"><i className="fa-brands fa-facebook"></i></a> Lheymar Catapang <small>(Student)</small></h3>
                    ...
                    <div data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <h3><a target="_blank" href="https://web.facebook.com/brecio.charlesfrancis"><i className="fa-brands fa-facebook"></i></a> Charles Francis <small>(Student)</small></h3>
                    ...
                    <div data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <h3><a target="_blank" href="https://web.facebook.com/profile.php?id=100078759327384"><i className="fa-brands fa-facebook"></i></a> Melissa Ayala <small>(Student)</small></h3>
                    ...
                    <div data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <h3><a target="_blank" href="https://web.facebook.com/jeromee.dev.22"><i className="fa-brands fa-facebook"></i></a> Jerome Bulosan <small>(Student)</small></h3>
                    ...
                    <div data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <h3><a target="_blank" href="https://web.facebook.com/kristine.Dingle.04"><i className="fa-brands fa-facebook"></i></a> Kristine Ocan Dingle <small>(Student)</small></h3>
